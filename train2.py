...
from gpt2tiny.utils import _download_resume_ckpt
...
def main(
    ...
    # Always have a real local directory, regardless of logger internals
...
if __name__ == "__main__":
    ...
    trainer_config = TrainingConfig(batch_size=64, num_workers=4, max_iters=5000)
